...
$final_ending = str_replace("brp.", "", $ending1);

require("../../mysql.php");

$sql = "SELECT * FROM ".$final_ending." WHERE ENDING = 'youtube'";
...
<meta property="og:title" content="BetterRolePlay - youtube">
...
<meta property="twitter:title" content="BetterRolePlay - youtube">
...
<span class="text-2xl">Didn't get redirected? <a class="text-blue-500" href="https://youtube.com">Click here</a>.</span>
