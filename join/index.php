...
$sql = "SELECT * FROM ".$final_ending." WHERE ENDING = 'join'";
...
<meta property="og:title" content="BetterRolePlay - join">
...
<meta property="twitter:title" content="BetterRolePlay - join">
