...
$sql = "SELECT * FROM ".$final_ending." WHERE ENDING = 'better'";
...
<meta property="og:title" content="BetterRolePlay - better">
...
<meta property="twitter:title" content="BetterRolePlay - better">
